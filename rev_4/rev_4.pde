...
void draw()
{
  ...
  Sphere sph1 = new Sphere(new PVector(3, 0, 25), 1);
  shapes.add(sph1);
  Sphere sph2 = new Sphere(new PVector(2, 0, 25), 1);
  shapes.add(sph2);
  Sphere sph3 = new Sphere(new PVector(1, 0, 15), 1);
  shapes.add(sph3);
  Sphere sph4 = new Sphere(new PVector(0, 0, 10), 1);
  shapes.add(sph4);
  Sphere sph5 = new Sphere(new PVector(-1, 0, 5), 1);
  shapes.add(sph5);
  ...
  kDif =  new FColor(0.3, 0.5, 0);
  kSpe =  new FColor(0.2, 0.3, 2);
  shine = 8;
